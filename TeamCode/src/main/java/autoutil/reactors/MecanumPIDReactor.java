...
public class MecanumPIDReactor extends MecanumReactor{
    ...
    public PID xPID = new PID(PID.PIDParameterType.STANDARD_FORM_ALL, 0.025, 15.0, 0.1, 50.0, 5.0);
    public PID yPID = new PID(PID.PIDParameterType.STANDARD_FORM_ALL, 0.025, 15.0, 0.1, 50.0, 5.0);
...
//        hPID.setAccuracy(3);
        ...
        xPID.setAccuracy(0.8);
        yPID.setAccuracy(0.8);
