...
//        addScaledSetpoint(1.0, 0,128, -90);
        ...
        customNumber(5, i -> {
            switch (i){
                case 0: s = -0.2; x = -0.2; t = 0.0; break;
                case 1: s = 1.0; x = 0.6; t = 1.5; break;
                case 2: s = 1.5; x = 1.1; t = 3.0; break;
                case 3: s = 2.0; x = 1.7; t = 4.5; break;
            ...
            addTimedWaypoint( 0.3, 0.3, 58-x, 124 + s, 87-t);
            addCancelAutoModules();
            ...
            addCancelAutoModules();
            addConcurrentAutoModule(BackwardAuto2);
            addTimedSetpoint(1.0, 0.6, 0.6, -7.3-x, 136 + s, 53-t);
            addCancelAutoModules();
        ...
        addSegment(1.0, mecanumDefaultWayPoint, -190.0, y, -93);
        addSegment(0.7, mecanumDefaultWayPoint,  -232.0, y, -93);
        ...
        addSegment(0.6, mecanumDefaultWayPoint, -183, y+10, -52);
        addCancelAutoModules();
        addConcurrentAutoModule(BackwardAuto2);
        addTimedSetpoint(1.0, 0.5, 0.7, -167, y+11.5, -52);
        addCancelAutoModules();
        addConcurrentAutoModule(ForwardAuto2(0));
        addPause(0.25);
        ...
        addCancelAutoModules();
        addConcurrentAutoModule(BackwardAuto2);
        addTimedSetpoint(1.0, 0.5, 0.7, -165, y+11.5, -52);
        addCancelAutoModules();
        addConcurrentAutoModule(ForwardAuto2(5));
        addPause(0.25);
        addTimedSetpoint(1.0, 0.8, 0.5, -176.0, y, 0);
