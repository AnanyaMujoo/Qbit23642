...
@Autonomous(name = "QbitAuto3Samp", group = "auto")
public class QbitAuto3Samp extends AutoFramework {
...
//        addCustomCode(intake::flipAlmost);
        ...
        addTimedSetpoint(0.5, 1, -19.5, 57, 0);
        ...
        addTimedSetpoint(0.5, 0.4, -34, 24, -45);
        addTimedSetpoint(0.5, 1, -46.5, 58, 0);
        addAutoModuleDONOTUSE(In);
