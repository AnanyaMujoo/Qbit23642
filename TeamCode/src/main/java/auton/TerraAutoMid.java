...
public class TerraAutoMid extends AutoFramework {
    ...
    AutoModule Backward = new AutoModule(
            lift.stageLift(1.0, heightMode.getValue(MIDDLE)+1).attach(outtake.stageReadyEndContinuous(0.6))
    ...
    public void define() {
        ...
        customNumber(5, i -> {
            ...
            addSegment(0.7, mecanumDefaultWayPoint, 18, 127+y, 108);
            customFlipped(() -> {
                addSegment(0.6, mecanumDefaultWayPoint, 49, 128+y, 90);
                addSegment(0.4, slowDownStopSetPoint, 69, 128+y, 90);
            }, () -> {
                addSegment(0.6, mecanumDefaultWayPoint, 51, 128+y, 90);
            ...
            addSegment(0.5, mecanumDefaultWayPoint, 25, 127+y, 95);
            addConcurrentAutoModuleWithCancel(Backward);
