...
@Autonomous(name = "Qbit5SpecNoReset", group = "auto")
public class Qbit5SpecNoReset extends AutoFramework {
...
//        addCustomCode(intake::flipAlmost);
        ...
        addTimedSetpoint(0.1, 0.42, -5, 90, 0);
...
//        addWaypoint(1, 160, 130, 180);
        ...
        customNumber(4, i -> {
            ...
            // 0.35
            addTimedSetpoint(0.15,i == 0 ? 0.3 : 0.40, 92+x,-7,180);
