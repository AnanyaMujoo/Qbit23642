...
@Autonomous(name="Omni Drive To AprilTag Auto", group = "Autonomous")
public class ApriltagAuto extends LinearOpMode
{
    ...
    final double MAX_AUTO_TURN  = 0.02;   //  Clip the turn speed to this max value (adjust for your robot)
